...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        [_emoticonBtn setImage:[UIImage nim_imageInKit:@"IM_icon_voice"] forState:UIControlStateNormal];
        [_emoticonBtn setImage:[UIImage nim_imageInKit:@"IM_icon_voice"] forState:UIControlStateHighlighted];
        [_emoticonBtn sizeToFit];
        
        _moreMediaBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_moreMediaBtn setImage:[UIImage nim_imageInKit:@"IM_icon_voice"] forState:UIControlStateNormal];
        [_moreMediaBtn setImage:[UIImage nim_imageInKit:@"IM_icon_voice"] forState:UIControlStateHighlighted];
...
{
    [self.emoticonBtn setImage:selected?[UIImage nim_imageInKit:@"IM_icon_voice"]:[UIImage nim_imageInKit:@"IM_icon_voice"] forState:UIControlStateNormal];
    [self.emoticonBtn setImage:selected?[UIImage nim_imageInKit:@"IM_icon_voice"]:[UIImage nim_imageInKit:@"IM_icon_voice"] forState:UIControlStateHighlighted];
}
