...
//        this.initTitleBar();
    ...
    public   void initTitleBar(){
        ...
        if(titleBar==null)
            return;
        titleBar.setBack();
        String navBarBgColor= getIntent().getStringExtra("navBarBgColor");
        if(navBarBgColor==null){
            navBarBgColor="#ffffff";
        }
        titleBar.layout.setBackgroundColor(Color.parseColor(navBarBgColor));

        String theme= getIntent().getStringExtra("theme");
        if(theme==null){
            theme="black";
        }
        StatusBar.setStatusBarStyle(theme,this);
        String color="#000000";
        if("white".equals(theme)){
            color="#ffffff";
        }
        else{
            titleBar.setBackImageTheme(theme);
        }
