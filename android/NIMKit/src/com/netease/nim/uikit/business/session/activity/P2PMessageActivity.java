...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.initTitleBar();
        titleBar.setTitle(UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P));
        AndroidBug5497Workaround.assistActivity(this.findViewById(R.id.message_fragment_container));
